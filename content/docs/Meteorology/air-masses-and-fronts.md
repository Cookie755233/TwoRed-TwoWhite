...
2. A region dominated by a general stagnation of atmospheric circulation.
\
...
![Typical Summer North American Pattern](/images/typesofairmasses.png "Typical Summer North American Pattern")

### Naming Patterns
1. How does the air mass stagnates?
	- **Maritime (m):** If the air mass stagnates over the ocean.
	- **Continental (c):** If the air mass stagnates over the continent.
2. How close is that air mass to the equator or the pole?
...
![Cold Front](/images/coldfront.png "Cold Front")
...
![Warm Front](/images/warmfront.png "Warm Front")
...
![Stationary Front](/images/stationaryfront.png "Stationary Front")
...
![Occluded Front](/images/occludedfront.png "Occluded Front")

Occluded front  typically happens in three stages:

1. A cold air mass and a warm air mass are moving, with characteristic clouds still separated.
2. The cold air starts to overtake and literally "run over" the warm air. The symbols combine into **purple** alternating triangles and half-circles. You get a mix of cumuliform and stratiform clouds, with a variety of precipitation.
3. The cold air has completely taken over the warm air, and the occlusion is well-established.
...
- Name two things that are necessary for an air mass to form.
	1. An extensive, uniform geographical area.
	2. A region dominated by general stagnation of atmospheric circulation.