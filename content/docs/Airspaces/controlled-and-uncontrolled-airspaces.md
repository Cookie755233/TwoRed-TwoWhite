...
![Airspace Divisions](/images/airspaces.png "Airspace Divisions")
...
- **Dimensions:**
    ...
    - **Outer Circle (Shelf):** 10 NM radius, from 1,200 feet to 4,000 feet AGL.
...
- **Dimensions:** A **4 nautical mile radius** from the surface up to **2,500 feet AGL**.\
  *However, The FAA may "tweak" the shape. For example, at New Smyrna, we are under the shelf of overlying Charlie airspace, so our Delta ends where the Charlie begins.*
- **Depiction:** It is depicted on your sectional chart by a **blue dashed line**.
...
![Surface area around an airport](/images/classesurface.png "Surface area around an airport")
![Extensions to the surface areas for an airport](/images/classeextension.png "Extensions to the surface areas for an airport")

- **Transition Airspace**:\
  Permits IFR traffic in the en route and airport environment to remain in controlled airspace while transitioning.
	- Begins at **700’ AGL (magenta vignette)** - Begins at **1,200’ AGL (Blue vignette)** ![Transition Airspace](/images/classetransition.png "Transition Airspace")
...
![Offshore Airspace Areas with Blue Zipper Lines](/images/classebluezipper.png "Offshore Airspace Areas with Blue Zipper Lines")
...
![Victor Airways](/images/classevictor.png "Victor Airways")
...
![Airspaces Categories](/images/airspacesnotes.png "Airspaces Categories")


![Airspace Minimums](/images/airspaceminimums.png "Airspace Minimums")
