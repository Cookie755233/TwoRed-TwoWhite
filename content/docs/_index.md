...
{{< cards >}}
  ...
  {{< card link="airport-operations" title="Airport Operations" icon="map" subtitle="Runways, taxiways, signs, lighting, and procedures." >}}
  {{< card link="principles-of-flight" title="Principles of Flight" icon="paper-airplane" subtitle="Lift, drag, thrust, and the four forces." >}}
  {{< card link="aerodynamics" title="Aerodynamics" icon="arrow-trending-up" subtitle="Stalls, stability, and airflow behaviour." >}}
  ...
  {{< card link="airspaces" title="Airspaces" icon="globe-alt" subtitle="Classes, requirements, and special use airspace." >}}
  {{< card link="performance" title="Performance" icon="rocket-launch" subtitle="Takeoff, landing, climb, and cruise performance." >}}
  ...
  {{< card link="navigation" title="Navigation" icon="map-pin" subtitle="VFR charts, dead reckoning, and navigation aids." >}}
